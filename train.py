...
parser.add_argument('--log_path', default='/home/hongyang/CODE/Cross_Modality_Baseline/logs/', type=str,help='log save path')
...
for epoch in range(start_epoch, 61-start_epoch):
    ...
    # identity sampler
    sampler = IdentitySampler(trainset.train_color_label, trainset.train_thermal_label, color_pos, thermal_pos, args.batch_size)
    trainset.cIndex = sampler.index1 # color index
    trainset.tIndex = sampler.index2 # thermal index
    trainloader = data.DataLoader(trainset, batch_size=args.batch_size, sampler = sampler, num_workers=args.workers, drop_last =True)
